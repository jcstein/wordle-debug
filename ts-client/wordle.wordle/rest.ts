...
/**
 * @title wordle/wordle/genesis.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/wordle/wordle/guess
   */
  queryGuessAll = (
    query?: {
   ...
   * @request GET:/wordle/wordle/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<WordleQueryParamsResponse, RpcStatus>({
      path: `/wordle/wordle/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/wordle/wordle/wordle
   */
  queryWordleAll = (
    query?: {
      "pagination.key"?: string;
